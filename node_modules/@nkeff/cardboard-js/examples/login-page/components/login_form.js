import { allTags, getMountPoint, computeMultiple, state, } from '../../../dist/cardboard.js';
...
export function LoginForm(formData) {
    ...
    const loginForm = form(InputField({
        id: 'username',
        labelText: 'Username',
        ...
        .addAttr('type', 'submit')).addAttr('action', '#').on('submit', (_, e) => {
        e.preventDefault();
        onSubmit();
    });
    getMountPoint()
